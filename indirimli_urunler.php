...
<head>
	...
	<title>İndirimli Ürünler | <?php echo $HDDizayn['title'];?></title>
	<meta name="description" content="Fırsat Ürünleri, İndirimli Ürünler, Uygun Fiyat">
	<meta name="keywords" content="Fırsat Ürünleri, İndirimli Ürünler, Uygun Fiyat">
	<meta name="author" content="<?php echo $Author;?>">
	<meta name="robots" content="<?php echo $HDDizayn['robots'];?>">
	<meta name="googlebot" content="<?php echo $HDDizayn['robots'];?>">
	<link rel="canonical" href="firsat-urunleri.html"/>
	<meta property="og:title" content="Fırsat Ürünleri | <?php echo $HDDizayn['title'];?>"/>
	<meta property="og:type" content="article" />
	<meta property="og:url" content="firsat-urunleri.html"/>
	<meta property="og:site_name" content="<?php echo $HDDizayn['title'];?>"/>
	<meta property="og:description" content="Fırsat Ürünleri, İndirimli Ürünler, Uygun Fiyat"/>
                ...
                <div class="row">
                    <div class="col-md-12 col-main">
                        <div class=" toolbar-products toolbar-top">
                            <h1 class="cate-title site-font" style="text-transform:uppercase; font-size:20px;">İndirimli Ürünler</h1>
                            <div class="modes">
                        ...
                        <div class="products products-grid">
                            <ol class="product-items row">
								...
								if						(!$sayfa){
								$sayfa				=	1;
								} $Bul 				= 	$Baglan->query("SELECT * FROM hddizayn_urunler WHERE durum = '1' and indirim = 1 ORDER BY ID DESC");
								...
								$Sorgu = $Baglan->query("SELECT * FROM hddizayn_urunler WHERE durum = '1' and indirim = 1 ".$Siralama." LIMIT $baslangicsayisi,$sayfalamalimiti");
								...
								<center>
									...
									<p style="font-weight:bold; font-size:18px; padding-top:20px;">İndirimli Ürünler Bulunamadı !<br/><br/><br/><br/></p>
								</center>
								<?php }else{											
								...
								$Sifir		= 0; $MevcutSayi = $HesapOrtalama; $BirYildiz  = 1.0; $ikiYildiz  = 2.0; $UcYildiz   = 3.0; $DortYildiz = 4.0; $BesYildiz  = 5.0;
