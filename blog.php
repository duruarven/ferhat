...
<head>
	...
	<title>Blog - <?php echo $HDDizayn['title'];?></title>
            ...
            <div class="columns container">      
                ...
                <div class="row">
                    <div class="col-md-9 col-md-push-3 col-main">
                            ...
                            <div class="bottom-pagination">
                                <nav>
									<ul class="pagination">
										...
										if						(!$sayfa){
										$sayfa				=	1;
										} $Bul 				= 	$Baglan->query("SELECT * FROM hddizayn_blog WHERE durum = '1'");
										...
										echo "<li class='bold'><a href='blog.html'><i class='fa fa-angle-left'></i></a></li>";
										echo "<li class='bold'><a href='blog.html?s=$sayfayibirgerial'>Geri</a></li>";
										...
										if($sayfa==$sayfaindex){echo "<li class='active bold'><a href='blog.html?s=$sayfaindex'>$sayfaindex</a></li>";
										}else{echo "<li class='bold'><a href='blog.html?s=$sayfaindex'>$sayfaindex</a></li>";
										}}}if($sayfa!=$toplamsayfasayisi){$sayfayibirilerial	=	$sayfa+1;
										echo "<li class='bold'><a href='blog.html?s=$sayfayibirilerial'>İleri</a></li>";
										echo "<li class='bold'><a href='blog.html?s=$toplamsayfasayisi'><i class='fa fa-angle-right'></i></a></li>";
										}
										?>
									</ul>
                                </nav>
                        ...
                        <ul class="blog-posts">
							<?php					
							$BlogBaktik 		= 	$Baglan->query("SELECT * FROM hddizayn_blog WHERE durum = '1' ORDER BY ID DESC LIMIT $baslangicsayisi,$sayfalamalimiti");
                                        ...
                                        <div class="col-sm-7">
                                            <div class="entry-ci">
                                                ...
                                                <div class="entry-excerpt">
                                                    <?php echo strip_tags(substr($BlogGorduk->aciklama,0,380))."..."; ?>
                                                </div>
												<br/>
