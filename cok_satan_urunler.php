...
<head>
	...
	<title>Çok Satan Ürünler | <?php echo $HDDizayn['title'];?></title>
	<meta name="description" content="Geniş Ürün yelpazesinde Çok Satan Ürünlerin hepsi burada !">
	<meta name="keywords" content="Fırsat Ürünleri,İndirimli Ürünler,Uygun Fiyat,Çok Satan Ürünler">
	<meta name="author" content="<?php echo $Author;?>">
	<meta name="robots" content="<?php echo $HDDizayn['robots'];?>">
	<meta name="googlebot" content="<?php echo $HDDizayn['robots'];?>">
	<link rel="canonical" href="cok-satanlar.html"/>
	<meta property="og:title" content="Fırsat Ürünleri | <?php echo $HDDizayn['title'];?>"/>
	<meta property="og:type" content="article" />
	<meta property="og:url" content="cok-satanlar.html"/>
	<meta property="og:site_name" content="<?php echo $HDDizayn['title'];?>"/>
	<meta property="og:description" content="Geniş Ürün yelpazesinde Çok Satan Ürünlerin hepsi burada !"/>
		...
		<main class="site-main">
            <div class="columns container">
                <ol class="breadcrumb no-hide">
					...
					<li>Çok Satan Ürünler</li>
                </ol>
                <div class="row">
                    <div class="col-md-12 col-main">
                        <div class=" toolbar-products toolbar-top">
                            <h1 class="cate-title site-font" style="text-transform:uppercase; font-size:20px;">Çok Satan Ürünler</h1>
                            <div class="modes">
                        ...
                        <div class="products products-grid">
                            <ol class="product-items row">
								...
								if						(!$sayfa){
								$sayfa				=	1;
								} $Bul 				= 	$Baglan->query("SELECT * FROM hddizayn_urunler WHERE durum = '1' and satis_adedi > '$Adet' OR cok_satan = '1' OR urun_puan > 100 ORDER BY satis_adedi DESC");
								$toplamkaydibul 	= 	$Bul->num_rows;
								$sayfalamalimiti	=	18;
								$baslangicsayisi	=	($sayfa*$sayfalamalimiti)-$sayfalamalimiti;
								$toplamsayfasayisi	=	ceil($toplamkaydibul/$sayfalamalimiti);	
								$Adet 				= 	$HDDizayn['populer_urun_adeti'];
								$Sorgu = $Baglan->query("SELECT * FROM hddizayn_urunler WHERE durum = '1' and satis_adedi > '$Adet' OR cok_satan = '1' OR urun_puan > 100 ORDER BY satis_adedi DESC LIMIT $baslangicsayisi,$sayfalamalimiti");
								...
								<center>
									...
									<p style="font-weight:bold; font-size:18px; padding-top:20px;">Ürün bulunamadı !<br/><br/><br/><br/></p>
								</center>
								<?php }else{ while($Urun = $Sorgu->fetch_object()){
						...
						<?php
						$Sorgu = $Baglan->query("SELECT * FROM hddizayn_urunler WHERE durum = '1' and cok_satan = 1");
						if(!$Baglan->affected_rows){
						?>
						<?php }else{ ?>	
						<div class="toolbar-products toolbar-bottom">
							<ul class="pagination">
								...
								echo "<li class='bold'><a href='cok-satanlar.html'><i class='fa fa-angle-left'></i></a></li>";
								echo "<li class='bold'><a href='cok-satanlar.html'?s=$sayfayibirgerial'>Geri</a></li>";
								...
								if($sayfa==$sayfaindex){ echo "<li class='active bold'><a href='cok-satanlar.html'?s=$sayfaindex'>$sayfaindex</a></li>";
								}else{ echo "<li class='bold'><a href='cok-satanlar.html'?s=$sayfaindex'>$sayfaindex</a></li>";
								}}} if($sayfa!=$toplamsayfasayisi){
								$sayfayibirilerial	=	$sayfa+1;
								echo "<li class='bold'><a href='cok-satanlar.html'?s=$sayfayibirilerial'>İleri</a></li>";
								echo "<li class='bold'><a href='cok-satanlar.html'?s=$toplamsayfasayisi'><i class='fa fa-angle-right'></i></a></li>";
								}
								?>
							</ul>
						</div>
